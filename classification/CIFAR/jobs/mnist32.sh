...
#SBATCH --output=/scratch/sunwbgt_root/sunwbgt98/xysong/vos/classification/CIFAR/jobs/mn32-eval.log
...
python test_customized.py --dataset mnist --score energy --method_name mnist-32 --num_to_avg 10 --model_name dense --nf 32 --test_energy_baseline