...
parser.add_argument('--save', '-s', type=str,
                    default='./snapshots/baseline', help='Folder to save checkpoints.')
        ...
        if sum_temp == num_classes * args.sample_number and epoch < args.start_epoch:
            ...
            for index in range(num_classes):
                if index == 0:
                    ...
                    X = torch.cat(
                        (X, data_dict[index] - data_dict[index].mean(0)), 0)
            ...
            if len(ood_samples) != 0:
                ...
                predictions_ood = net.fc(net.relu(net.fc0(ood_samples)))
